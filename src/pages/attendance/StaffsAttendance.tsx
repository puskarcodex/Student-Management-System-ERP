    ...
    <div className="p-4 md:px-8 md:pt-2 md:pb-8 bg-muted/30 min-h-screen">
      <main className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 ml-1 mt-2">
          <div>
            <h1 className="text-4xl font-extrabold tracking-tight text-foreground">Staff Attendance</h1>
            <p className="text-muted-foreground text-base font-medium mt-1">Track and record staff attendance</p>
          </div>
          <Button
